...
OFILES = gba.o font.o main.o gameCharacter.o images/lose_bec_moves.o images/selfMaze.o images/WON.o images/crash.o images/first_image.o images/character.o
